...
func (in *CappStatus) DeepCopyInto(out *CappStatus) {
	*out = *in
	...
	in.EnabledStatus.DeepCopyInto(&out.EnabledStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnabledStatus) DeepCopyInto(out *EnabledStatus) {
	*out = *in
	in.LastEnabeldChange.DeepCopyInto(&out.LastEnabeldChange)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnabledStatus.
func (in *EnabledStatus) DeepCopy() *EnabledStatus {
	if in == nil {
		return nil
	}
